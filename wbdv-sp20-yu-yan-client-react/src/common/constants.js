...
export const WIDGETS_API_URL = "https://cs5610-sp20-yyan-server.herokuapp.com/api/widgets"
...
export const TOPICS_WIDGETS_API_URL = (topicId) => `https://cs5610-sp20-yyan-server.herokuapp.com/api/topics/${topicId}/widgets`;
